        ...
        <div class="card-body">
            @if($customers)
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('invoice_number') is-invalid @enderror" name="invoice_number" value="{{ old('invoice_number', $invoice_number) }}" placeholder="{{ __('e.g. 2021001') }}">
                </div>
                <div class="form-group">
